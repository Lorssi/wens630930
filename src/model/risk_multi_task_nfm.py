...
class Has_Risk_NFM_MultiLabel(nn.Module):
    ...
    def __init__(self, params: dict): 
        ...
        self.head_1_7 = TaskHead_HasRisk(input_dim=8, output_dim=1)
        self.head_8_14 = TaskHead_HasRisk(input_dim=8, output_dim=1)
        self.head_15_21 = TaskHead_HasRisk(input_dim=8, output_dim=1)
    ...
    def forward(self, x):
        ...
        output_1_7 = self.head_1_7(feature)
        output_8_14 = self.head_8_14(feature)
        output_15_21 = self.head_15_21(feature)
