...
class ProductionFeature(BaseFeatureDataSet):
    ...
    def _post_processing_data(self):
        ...
        production_feature_list = ['stats_dt', 'pigfarm_dk', 'abortion_rate','abortion_mean_recent_7d',
                                   ...
                                   'basesow_sqty_change_ratio_7d', 'basesow_sqty_change_ratio_15d','basesow_sqty', 'abortion_rate_ma_diff',
                                   ] + past_7d_abortion_features + abortion_first_diff + abortion_second_diff
