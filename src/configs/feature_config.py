...
class ColumnsConfig:
    ...
    CONTINUOUS_COLUMNS = ['check_out_ratio_7d', 'death_confirm_2_week', 'intro_rule_21d', 'piglet_rule_21d', 'tame_rule_21d'] + past_7d_abortion_features
    INVARIANT_COLUMNS = ['season']

    # MODEL_FIT
    MODEL_DISCRETE_COLUMNS = ['pigfarm_dk','city','season']
    MODEL_CONTINUOUS_COLUMNS = ['check_out_ratio_7d', 'death_confirm_2_week', 'intro_rule_21d', 'piglet_rule_21d', 'tame_rule_21d'] + past_7d_abortion_features
