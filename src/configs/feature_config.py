...
class ColumnsConfig:
    ...
    CONTINUOUS_COLUMNS = ['check_out_ratio_7d', 'death_confirm_2_week', 'abnormal_find_days'] + past_7d_abortion_features
    INVARIANT_COLUMNS = ['season']

    # MODEL_FIT
    MODEL_DISCRETE_COLUMNS = ['pigfarm_dk','city','season']
    MODEL_CONTINUOUS_COLUMNS = ['check_out_ratio_7d', 'death_confirm_2_week', 'abnormal_find_days'] + past_7d_abortion_features
